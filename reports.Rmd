...
<div class="table_container">
  <table id="bottom_icons">
   <tr>
      <td><a title="100 million hectares of agricultural expansion in the tropics occurred from 1980 to 2000, mainly cattle ranching in Latin America (+/-42 million ha), and plantations in Southeast Asia (+/-7.5 million ha, of which 80% is oil palm), half of it at the expense of intact forests (IPBES GA)" tabindex="0"><img src="images/stick_figure_tree_green.png" alt="tree icon"/></a></td>
      <td><h3>Deforestation</h3></td>
      <td><a title="For terrestrial and freshwater ecosystems, land-use change has had the largest relative negative impact on nature since 1970, followed by the direct exploitation, in particular overexploitation, of animals, plants and other organisms, mainly via harvesting, logging, hunting and fishing. (IPBES GA)" tabindex="0"><img src="images/stick_figure_elephant_gray.png" alt="elephant icon"/></a></td>
      <td><h3>Over-<br/>exploitation</h3></td>
      <td><a title="Industrial fishing covers over 55% of ocean area (IPBES GA)" tabindex="0"><img src="images/stick_figure_fish_blue.png" alt="fish icon"/></a></td>
      <td><h3>Sea Use<br/>Changes</h3></td>
      <td><a title="Fertilizers have caused 400 low oxygen (hypoxic) coastal ecosystem 'dead zones', affecting over 245,000 km2 (IPBES GA)" tabindex="0"><img src="images/stick_figure_kelp_green.png" alt="kelp icon"/></a></td>
      <td><h3>Coastal<br/>Loss</h3></td>
      <td><a title="47% of terrestrial flightless mammals and 23% of threatened birds whose distributions may have been negatively impacted by climate change already (IPBES GA)" tabindex="0"><img src="images/stick_figure_atmosphere.png" alt="atmosphere icon"/></a></td>
      <td><h3>Greenhouse Gas<br/>Emissions</h3></td>
   </tr>
   <tr>
      <td><a title="Between $235 to $577 billion in annual value of global crop output are at risk due to pollinator loss (IPBES GA)" tabindex="0"><img src="images/stick_figure_insect.png" alt="insect icon"/></a></td>
      <td><h3>Pollinator<br/>Decline</h3></td>
      <td><a title="Almost 33% of reef forming corals, sharks and shark relatives, and over 33% marine mammals threatened with extinction (IPBES GA)" tabindex="0"><img src="images/stick_figure_ocean_blue.png" alt="ocean icon"/></a></td>
      <td><h3>Marine<br/>Pollution</h3></td>
      <td><a title="Urban areas have grown 100% since 1992 (IPBES GA)" tabindex="0"><img src="images/stick_figure_wetlands_green.png" alt="wetlands icon"/></a></td>
      <td><h3>Land Use<br/>Changes</h3></td>
      <td><a title="Over 500,000 of the world’s estimated 5.9 million terrestrial species have insufficient habitat for long term survival without habitat restoration (IPBES GA)" tabindex="0"><img src="images/stick_figure_monkey_brown.png" alt="monkey icon"/></a></td>
      <td><h3>Habitat<br/>Loss</h3></td>
      <td><a title="Food crop production have increased by 300% since 1970 with 23% of land areas seeing a reduction in productivity due to land degradation (IPBES GA)" tabindex="0"><img src="images/stick_figure_soil_green.png" alt="soil icon"/></a></td>
