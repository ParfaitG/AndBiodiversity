...
<iframe sandbox="allow-same-origin allow-scripts allow-popups allow-forms" width="100%" height="450" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/1547995132&color=%23ff5500&auto_play=false&hide_related=false&show_comments=false&show_playcount=false&show_user=false&show_reposts=false&show_teaser=false"></iframe>

<sub>Note: This SoundCloud embed uses cookies in accordance to their [cookie policy](https://soundcloud.com/pages/cookies){target="_blank"}.</sub>
