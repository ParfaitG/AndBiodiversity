...
<div class="accordion">
  ...
  <img src="images/clip_trees.png" height="120px" alt="different tree color icons"/>
  </div>
</div>
<div class="accordion">
...
<div class="accordion">
  ...
  <img src="images/clip_globes.png" height="120px" alt="different globe color icon"/>
  </div>
</div>
<div class="accordion">
  ...
  <img src="images/clip_calendars.png" height="120px" alt="different calendar color icons"/>
  </div>
</div>
<div class="accordion">
  ...
  <img src="images/clip_exclamations.png" height="120px" alt="different exclamation point color icon"/>
  </div>
</div>
<div class="accordion">
  ...
  <img src="images/clip_lightbulbs.png" height="170px" alt="different light bulb color icon"/>
  </div>
</div>
</div>
...
<div class="accordion-wrapper" id="globalmoments">
 <div class="accordion">
  ...
  <img src="images/icon_unep.png" alt="UNEP icon"/>
  <img src="images/icon_cites.png" alt="CITES icon"/>
  </div>
 </div>
 <div class="accordion">
  ...
  <img src="images/icon_ipcc.png" alt="IPCC icon"/>
  </div>
 </div>
 <div class="accordion">
  ...
  <img src="images/icon_conventionbiodiversity.png" height="150px" alt="CBD icon"/>
  <img src="images/report_wcmc1992.png" height="150px" alt="WCMC 1992 report cover"/>
  <img src="images/report_unepglobal1995.png" height="150px" alt="UNEP 1995 report cover"/>
  </div>
 </div>
 <div class="accordion">
  ...
  <ul>
   ...
   <img src="images/icon_unmdg.png" alt="UN MDG icon"/>
   <img src="images/report_mea2005.png" alt="MEA 2005 report cover"/>
   <img src="images/planetary_boundaries_2009.jpg" alt="Planetary Boundary Framework (2009)"/>
  </div>
 </div>
 <div class="accordion">
  ...
  <ul>
   ...
   <img src="images/icon_unbiodecade.png" alt="UN Biodiversity Decade icon"/>
   <img src="images/icon_ipbes.png" alt="IPBES icon"/>
   <img src="images/report_ipbes2019.png" alt="IPBES Global Assessment report cover"/>
  </div>
 </div>
 <div class="accordion">
  ...
  <img src="images/report_ipbesipcc2021.png" alt="IPBES and IPCC report cover"/>
  <img src="images/icon_cop15.png" alt="COP15 icon"/>
  </div>
 </div>
</div>
...
<div class="accordion-wrapper" id="solutions">
 <div class="accordion">
  ...
  <ul>
   ...
   <img class="multiple-figure" src="images/stick_figure_monkey_brown.png" alt="monkey icon"/>
   <img class="multiple-figure" src="images/stick_figure_wetlands_green.png" alt="wetlands icon"/>
   <img class="multiple-figure" src="images/stick_figure_fish_blue.png" alt="fish icon"/>
  </div>
 </div>
 <div class="accordion">
  ...
  <ul>
   ...
   <img class="multiple-figure" src="images/stick_figure_soil_green.png" alt="soil icon"/>
   <img class="multiple-figure" src="images/stick_figure_tree_green.png" alt="tree icon"/>
   <img class="multiple-figure" src="images/stick_figure_fish_blue.png" alt="fish icon"/>
  </div>
 </div>
 <div class="accordion">
  ...
  <div class="single-figure">
   <img src="images/dasgupta_review_fig3.png" alt="nature capital icon"/>
 ...
 <div class="accordion">
  ...
  <div class="single-figure">
   <img src="images/unep_makingpeace_fig6_3.png" alt="actions to restore life graph"/>
 ...
 <div class="accordion">
  ...
  <div class="single-figure">
   <img src="images/ipbes_ipcc_fig2_2.png" alt="multifunctional scapes figure"/>
 ...
 <div class="accordion">
  ...
  <div class="single-figure">
   <img src="images/dasgupta_review_fig21.png" alt="dasgupta solutions figure"/>
...
<table id="bottom_icons">
   <tr>
      ...
      <td><span data-text="Nature-based solutions for coastal flood protection, such as using natural coastal habitats (vegetation or coral reefs) to provide protection from flooding during storm events (IPBES-IPCC)" tabindex="0"><img src="images/stick_figure_kelp_green.png" alt="kelp icon"/></span></td>
      <td><h3>Coastal<br/>Restoration</h3></td>
      <td><span data-text="Reducing greenhouse gas (GHGs) emissions through the development of renewable energies in the transport and energy sector are important options for mitigating climate change (IPBES-IPCC)." tabindex="0"><img src="images/stick_figure_atmosphere.png" alt="atmosphere icon"/></span></td>
      <td><h3>Decarbonization</h3></td>
   </tr>
   <tr>
      <td><span data-text="Irrigated rice agriculture has evolved over centuries and led to a well-balanced food web in paddies with an insect diversity even higher than in many (pristine) temperate forests. (IPBES-IPCC)" tabindex="0"><img src="images/stick_figure_insect.png" alt="insect icon"/></span></td>
      <td><h3>Pest<br/>Control</h3></td>
      <td><span data-text="Local management (e.g., integrated coastal zone management and marine protected areas) can play an important role to improve ocean health. (IPBES-IPCC)" tabindex="0"><img src="images/stick_figure_ocean_blue.png" alt="ocean icon"/></span></td>
      <td><h3>Local<br/>Management</h3></td>
      <td><span data-text="Protection and restoration of wetlands, peatlands and coastal habitats reduces net carbon loss to the atmosphere (primarily from the oxidation of sediments and soil carbon) (IPBES-IPCC)" tabindex="0"><img src="images/stick_figure_wetlands_green.png" alt="wetlands icon"/></span></td> 
      <td><h3>Wetland<br/>Restoration</h3></td>
      <td><span data-text="Trophic rewilding, is a measure to enhance biodiversity and can also contribute to ecosystem restoration (IPBES-IPCC)." tabindex="0"><img src="images/stick_figure_monkey_brown.png" alt="monkey icon"/></td>
      <td><h3>Trophic<br/>Rewilding</h3></span></td>
      <td><span data-text="Reducing tillage, using less pesticides and increasing organic material input enhances the abundance and diversity of soil organisms. (IPBES-IPCC)" tabindex="0"><img src="images/stick_figure_soil_green.png" alt="soil icon"/></span></td>
